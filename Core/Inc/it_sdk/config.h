...
#define ITSDK_WITH_UART_RXIRQ		__UART_USART2							// Setup some of the UART with IRQ enabled for RX : __UART_USART2
...
#define ITSDK_WITH_WDG				__WDG_NONE//__WDG_IWDG								// Allows to disable the watchdog __WDG_IWDG
